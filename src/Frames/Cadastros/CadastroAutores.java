 ...
 * @author hilton
 */
public final class CadastroAutores extends javax.swing.JInternalFrame {
...
//    private int[] arrayEntidades, arrayCategorias;
    ...
    public CadastroAutores() {
        initComponents();
        tabelaAutores();
        setFrameIcon(new javax.swing.ImageIcon(this.getClass().getResource("/imagens/autor_24.png")));
        jTFnomeAutor.setDocument(new util.FormatarCampo(3, "textopadrao"));
        jTFsobrenomeAutor.setDocument(new util.FormatarCampo(3, "textopadrao"));
    }
    ...
    public DefaultTableModel tabelaAutores() {
        ...
        DefaultTableModel modelo = new DefaultTableModel(null, new String[]{
            "CÓDIGO", "NOME", "SOBRENOME", "SITUAÇÃO"}) {
...
//            listaAnexos = emfAnexos.findSuporteAnexosOrdenado();
            listaAutores = emfAutores.findAutoresEntitiesOrdenado();
        } catch (Exception ex) {
        ...
        if (!listaAutores.isEmpty()) {
            for (int i = 0; i < listaAutores.size(); i++) {
                try {
                    modelo.addRow(linha);
                    try {
                        modelo.setValueAt(listaAutores.get(i).getIAutor(), l, 0);
                    } catch (NullPointerException erro) {
                        System.out.println("Atenção! Campos vazios.");
                    }
                    try {
                        modelo.setValueAt(listaAutores.get(i).getNomeAutor(), l, 1);
                    } catch (NullPointerException erro) {
                        System.out.println("Atenção! Campos vazios.");
                    }
                    try {
                        modelo.setValueAt(listaAutores.get(i).getNomeSobrenome(), l, 2);
                    } catch (NullPointerException erro) {
                        System.out.println("Atenção! Campos vazios.");
                    }
                    try {
                        modelo.setValueAt(listaAutores.get(i).getSituacaoAutores(), l, 3);
                    } catch (NullPointerException erro) {
                        System.out.println("Atenção! Campos vazios.");
                    }
                } catch (NullPointerException erro) {
...
//    }
    ...
    private void initComponents() {
        ...
        jTFsobrenomeAutor = new javax.swing.JTextField();
        ...
        setToolTipText("");
        setMinimumSize(new java.awt.Dimension(457, 338));
        ...
        jTFnomeAutor.setEditable(false);

        jLabel15.setText("Sobrenome:");

        jTFsobrenomeAutor.setEditable(false);
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                                ...
                                .addComponent(jTFsobrenomeAutor))
                            .addGroup(layout.createSequentialGroup()
                                .addComponent(jBnovo)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jTFsobrenomeAutor, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(jLabel15))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
...
//        jCBcategorias.setSelectedIndex(0);
    ...
    public void campos(boolean estado) {
        ...
        jTFnomeAutor.setEditable(estado);
        jTFsobrenomeAutor.setEditable(estado);
        jCBsituacao.setEnabled(estado);
        jTFsobrenomeAutor.setEnabled(estado);
    }
...
//        jProg.setString("");
        ...
        int i_autores = Integer.parseInt(String.valueOf(jTautores.getValueAt(jTautores.getSelectedRow(), 0)));
        Autores autores = emfAutores.findAutores(i_autores);
        campos(true);
        jBnovo.setEnabled(true);
        jBgravar.setEnabled(true);
...
//        jBanexar.setEnabled(false);
        ...
        jTFcodigo.setText(String.valueOf(autores.getIAutor()));
        jTFnomeAutor.setText(autores.getNomeAutor());
        jTFsobrenomeAutor.setText(autores.getNomeSobrenome());
        if (!autores.getSituacaoAutores().equals("ATIVO")) {
...
//        nivelSecretario(nivel);
    ...
    public Autores gravarCampos(Autores autores) {
        autores.setNomeAutor(jTFnomeAutor.getText());
        autores.setNomeSobrenome(jTFsobrenomeAutor.getText());
        autores.setSituacaoAutores(String.valueOf(jCBsituacao.getSelectedItem()));
    ...
    public void gravar() {
        if (validarCamposVazios()) {
            ...
            switch (modoGravar) {
                case "NOVO":
                    autores = new Autores();
                    autores = gravarCampos(autores);
                    emfAutores.create(autores);
                    jBnovo.setEnabled(true);
//                    jBanexar.setEnabled(true);
                    campos(false);
                    tabelaAutores();
                    break;
                case "EDITAR":
                    autores = emfAutores.findAutores(Integer.parseInt(jTFcodigo.getText()));
                    autores = gravarCampos(autores);
                    try {
                        emfAutores.edit(autores);
                    } catch (Exception ex) {
                        ex.printStackTrace();
    ...
    private javax.swing.JTextField jTFsobrenomeAutor;
