 ...
 * @author hilton
 */
public final class CadastroEditoras extends javax.swing.JInternalFrame {
...
//    private int[] arrayEntidades, arrayCategorias;
    ...
    public CadastroEditoras() {
        initComponents();
        tabelaEditoras();
        setFrameIcon(new javax.swing.ImageIcon(this.getClass().getResource("/imagens/editora_24.png")));
        jTFnomeEditoras.setDocument(new util.FormatarCampo(3, "textopadrao"));
    }
    ...
    public DefaultTableModel tabelaEditoras() {
...
//            listaAnexos = emfAnexos.findSuporteAnexosOrdenado();
        ...
        if (!listaEditoras.isEmpty()) {
            for (int i = 0; i < listaEditoras.size(); i++) {
                try {
                    modelo.addRow(linha);
                    try {
                        modelo.setValueAt(listaEditoras.get(i).getIEditora(), l, 0);
                    } catch (NullPointerException erro) {
                        System.out.println("Atenção! Campos vazios.");
                    }
                    try {
                        modelo.setValueAt(listaEditoras.get(i).getNomeEditora(), l, 1);
                    } catch (NullPointerException erro) {
                        System.out.println("Atenção! Campos vazios.");
                    }
                    try {
                        modelo.setValueAt(listaEditoras.get(i).getSituacaoEditora(), l, 2);
                    } catch (NullPointerException erro) {
                        System.out.println("Atenção! Campos vazios.");
                    }
                } catch (NullPointerException erro) {
        ...
        jTeditoras.setModel(modelo);
        //tamanhoColunas(jTeditoras);
        return modelo;
        //</editor-fold>
    }
...
//    }
    ...
    private void initComponents() {
        ...
        jTFnomeEditoras = new javax.swing.JTextField();
        ...
        jTeditoras.setAutoCreateRowSorter(true);
        ...
        jTeditoras.setSelectionMode(javax.swing.ListSelectionModel.SINGLE_SELECTION);
        ...
        jTFnomeEditoras.setEditable(false);
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jTFnomeEditoras, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(jLabel14))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
...
//        jCBcategorias.setSelectedIndex(0);
    ...
    public void campos(boolean estado) {
        ...
        jTFnomeEditoras.setEditable(estado);
...
//        jProg.setString("");
        ...
        int i_editora = Integer.parseInt(String.valueOf(jTeditoras.getValueAt(jTeditoras.getSelectedRow(), 0)));
        Editoras Editoras = emfEditoras.findEditoras(i_editora);
        campos(true);
        jBnovo.setEnabled(true);
        jBgravar.setEnabled(true);
...
//        jBanexar.setEnabled(false);
        ...
        jTFcodigo.setText(String.valueOf(Editoras.getIEditora()));
        jTFnomeEditoras.setText(Editoras.getNomeEditora());
        if (!Editoras.getSituacaoEditora().equals("ATIVO")) {
...
//        nivelSecretario(nivel);
    ...
    public Editoras gravarCampos(Editoras editoras) {
        editoras.setNomeEditora(jTFnomeEditoras.getText());
        editoras.setSituacaoEditora(String.valueOf(jCBsituacao.getSelectedItem()));
        ...
        if (validarCamposVazios()) {
            ...
            switch (modoGravar) {
                case "NOVO":
                    ...
                    editoras = gravarCampos(editoras);
                    emfEditoras.create(editoras);
                    jBnovo.setEnabled(true);
//                    jBanexar.setEnabled(true);
                    campos(false);
                    tabelaEditoras();
                    break;
                case "EDITAR":
                    editoras = emfEditoras.findEditoras(Integer.parseInt(jTFcodigo.getText()));
                    editoras = gravarCampos(editoras);
                    try {
                        emfEditoras.edit(editoras);
                    } catch (Exception ex) {
                        ex.printStackTrace();
    ...
    public boolean validarCamposVazios() {
        if (jTFnomeEditoras.getText() == null) {
            return false;
        } else {
            return true;
        }
    ...
    private javax.swing.JTextField jTFnomeEditoras;
